...
/* package second-example-0.1.0.0 */
#ifndef VERSION_second_example
#define VERSION_second_example "0.1.0.0"
#endif /* VERSION_second_example */
#ifndef MIN_VERSION_second_example
#define MIN_VERSION_second_example(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_second_example */
...
#define CURRENT_COMPONENT_ID "second-example-0.1.0.0-5QFUqroQBKi9onHdTYPG1v-second-example"
